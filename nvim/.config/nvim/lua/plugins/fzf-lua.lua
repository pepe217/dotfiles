...
return {
  {
    ...
    keys = {
      ...
      { '<leader>i', '<cmd>FzfLua live_grep<cr>', desc = 'Live grep' },
      { '<leader>I', '<cmd>FzfLua grep<cr>', desc = 'Grep' },
      { '<leader>sg', '<cmd>FzfLua live_grep_resume<cr>', desc = 'Live grep resume' },
      { '<leader>sG', '<cmd>FzfLua grep_last<cr>', desc = 'Grep resume' },
      { '<leader>sq', '<cmd>FzfLua lgrep_quickfix<cr>', desc = 'Grep qflist' },
      { '<leader>sQ', '<cmd>FzfLua quickfix_stack<cr>', desc = 'Grep qfstack' },
      { '<leader>sl', '<cmd>FzfLua lgrep_loclist<cr>', desc = 'Grep loclist' },
